...
class BuildCrossDataset(Dataset):
    def __init__(
        self,
...
if __name__ == "__main__":
    ...
    dataset_path = "../crosscompiler/results/text_bin"
    feature_csv_path = "../crosscompiler/results/labels.csv"

    dataset = BuildCrossDataset(
        dataset_path,
